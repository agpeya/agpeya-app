  ...
  return (
    <ContextMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "select-none data-[inset]:pl-8 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg]:size-4",
        className
      )}
      {...props}
    >
...
export function ContextMenuSubContent({
  ...
  return (
    <ContextMenuPrimitive.SubContent
      ...
      className={cn(
        "bg-popover text-popover-foreground z-50 min-w-[8rem] overflow-hidden border p-1 rounded-md shadow-lg",
  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        ...
        className={cn(
          "bg-popover text-popover-foreground z-50 max-h-[var(--radix-context-menu-content-available-height)] min-w-[8rem]",
          "overflow-hidden overflow-y-auto border p-1 rounded-md shadow-md",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
          "data-[state=open]:zoom-in-95 data-[state=closed]:zoom-out-95",
          "data-[side=top]:slide-in-from-bottom-2 data-[side=bottom]:slide-in-from-top-2",
...
export function ContextMenuItem({
  ...
  return (
    <ContextMenuPrimitive.Item
      ...
      className={cn(
        "flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 text-sm select-none outline-none",
