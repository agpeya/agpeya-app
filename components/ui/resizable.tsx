...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.PanelResizeHandle
      ...
      className={cn(
        "relative flex w-px items-center justify-center bg-border focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 " +
